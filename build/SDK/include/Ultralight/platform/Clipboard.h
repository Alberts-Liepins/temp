...
///
/// AppCore automatically provides a platform-specific implementation of this that
/// cuts/copies/pastes to the OS clipboard when you call App::Create().
///
/// If you are using Renderer::Create() instead, you will need to provide your own implementation of
/// this. @see Platform::set_clipboard().
///
