...
class UExport Platform {
 public:
  ...
  ///
  /// @param  clipboard  A user-defined Clipboard implementation, ownership remains with the caller.
  ///
  ...
  ///
  /// This can be used to provide a platform-specific bitmap surface for View to paint into when the
  /// CPU renderer is enabled. See View::surface().
  ///
  ...
  ///
  /// @note  A default BitmapSurfaceFactory is set by default, View::surface() can be safely cast to
  ///        BitmapSurface if you don't define your own.
  ///
