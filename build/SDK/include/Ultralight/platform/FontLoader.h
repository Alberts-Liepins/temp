...
class UExport FontLoader {
 public:
  ...
  ///
  virtual String16 fallback_font_for_characters(const String16& characters, int weight,
                                                bool italic) const = 0;
  ...
  ///          another font.
  ///
  virtual RefPtr<FontFile> Load(const String16& family, int weight, bool italic) = 0;
};
